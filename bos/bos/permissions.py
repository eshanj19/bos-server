...
# READINGS
PERMISSION_CAN_ADD_READING = ('add_userreading', 'Can add user reading', 'users.add_userreading')
PERMISSION_CAN_CHANGE_READING = ('change_userreading', 'Can change user reading', 'users.change_userreading')
PERMISSION_CAN_DESTROY_READING = ('delete_userreading', 'Can delete user reading', 'users.delete_userreading')
PERMISSION_CAN_VIEW_READING = ('view_userreading', 'Can view user reading', 'users.view_userreading')
