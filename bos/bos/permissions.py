...
# FILE
PERMISSION_CAN_ADD_FILE = ('add_file', 'Can add file', 'files.add_file')
PERMISSION_CAN_CHANGE_FILE = ('change_file', 'Can change file', 'files.change_file')
PERMISSION_CAN_DESTROY_FILE = ('delete_file', 'Can delete file', 'files.delete_file')
